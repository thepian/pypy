...
class PyPyTarget(object):
    ...
    def get_entry_point(self, config):
        ...
        # manually imports commands_main.py
        filename = os.path.join(this_dir, 'commands_main.py')
        app = gateway.applevel(open(filename).read(), 'commands_main.py', 'commands_main')
